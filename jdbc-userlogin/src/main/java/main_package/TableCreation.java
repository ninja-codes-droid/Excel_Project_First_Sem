...
public class TableCreation {
    ...
    private static void createStudentTable(Connection conn) throws SQLException {
        ...
        String sql = "CREATE TABLE studentdb ("
                ...
                + "number1 varchar(8) NOT NULL,"
                + "PRIMARY KEY (coll,cate,number1)"
                + ")";
    ...
    private static void createSubjectTable(Connection conn) throws SQLException {
        Statement stmt = conn.createStatement();
        String sql = "CREATE TABLE subjectdb ("
    ...
    private static void createMarksTable(Connection conn) throws SQLException {
        Statement stmt = conn.createStatement();
        String sql = "CREATE TABLE marksdb ("
                + "paper_type varchar(8) NOT NULL,"
                + "full_marks varchar(3) DEFAULT NULL,"
                + "marks_obt varchar(6) DEFAULT NULL,"
                + "coll varchar(8) NOT NULL,"
                + "cate varchar(8) NOT NULL,"
                + "number1 varchar(8) NOT NULL,"
                + "paper_code varchar(20) NOT NULL,"
                + "PRIMARY KEY (coll,cate,number1,paper_type,paper_code),"
    ...
    private static void createExamTable(Connection conn) throws SQLException {
        Statement stmt = conn.createStatement();
        String sql = "CREATE TABLE examdb ("
